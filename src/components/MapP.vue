<template>
  <div>
    <div id="panel" class="pl"></div>
    <div id="container" style="width: 520px; height: 650px;" class="map">
      <div class="searchbox">
        <img class="usellogo"
        ...
        <div >
          <el-row class="demo-autocomplete">
            <el-col >
              <el-autocomplete
                  class=" iptbox inline-input el-input__inner"
                  v-model="state"
...
export default {
  ...
  methods: {
    ...
    find(queryString){
      this.request.get("amap/place/text?offset=10&page=1&key=a383aad888722e5462d2e2392b7614e4&extensions=all&keywords="+queryString+"&output=JSON").then(res=>{
